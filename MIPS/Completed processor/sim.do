...
vlog _mips_control__alu_unit.v _mips_control__main_unit.v alu.v barrel_shifter.v data_memory.v data_tract_v2.v instruction_memory.v mips_control_unit_full.v mips_full_tb.v mux_5_bit.v mux_32_bit.v program_counter.v register_file.v sign_extender.v mips_1_tact_full_processor.v
